...
while True:
    ...
    for i in user_word: #limit user input to word only (no numbers & special char)
        if i.isdigit() or i in char.split():
            word = False

    if word:
        #check spelling
        spellCheck = Words(user_word.lower())
        check = spellCheck.check_exist()

        #word spelled correctly
        if check == True:
            print("\n>>> Congrats! The word", user_word, "is spelled correctly.\n")

        #word spelled wrong
        else:
            suggestion = []
        
            print("\n>>> Oops! The word entered might be wrong\n")
            ...
            if spellCheck.list:
                ...
                while True:
                    choice = input("\nPlease choose the desired word (no.): ")

                    if choice.isdigit():
                        if 0 < int(choice) <= len(suggestion) :
                            break
                        else:
                ...
                print ("\n>>> The correct word : ", end='')
                print (suggestion[int(choice)-1],"\n")
            
            else:
                print ("\n>>> No suitable word can be found in dictionary\n")
        
    else:
        print ("\n>>> Error!!! Please type in word\n")
        continue
    ...
    while True:
        ...
        if choice == "Y" or choice == "y":
            ...
            print("\n>>> Error! Please key in the right input.")
            continue
